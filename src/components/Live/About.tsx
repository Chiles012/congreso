    ...
    return (
        ...
        <div className="about-content">
            ...
            <div className="about-text">
                <h2>About Lorem</h2>
                <p> La educación Montessori es un enfoque de enseñanza que se basa en la idea de que los niños son naturalmente curiosos y autodirigidos. 
                    En lugar de imponer un plan de estudios rígido, los educadores Montessori crean un ambiente de aprendizaje en el que los niños pueden explorar y descubrir a su propio ritmo.
